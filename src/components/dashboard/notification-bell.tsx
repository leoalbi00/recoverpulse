      ...
      {open && (
        <div className="absolute top-full right-0 z-50 mt-2 w-80 max-h-96 overflow-y-auto rounded-xl border border-zinc-200 bg-white text-zinc-900 shadow-xl">
              ...
              notifications.map((notification) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "flex w-full items-start gap-3 border-b border-l-4 border-zinc-200 px-4 py-3 text-left transition-colors last:border-b-0 hover:bg-zinc-100",
                      notification.read
          ...
          <Link
            ...
            className="block border-t border-zinc-200 px-4 py-2.5 text-center text-xs font-medium text-emerald-600 hover:bg-zinc-100 hover:text-emerald-700"
          >
            Vedi tutte
          </Link>
        </div>
