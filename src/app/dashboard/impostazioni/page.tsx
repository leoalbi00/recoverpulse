  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10 sm:py-12">
      ...
      <section className="mt-8">
        <h2 className="text-sm font-medium text-zinc-700 dark:text-zinc-300">Brand &amp; Personalizzazione</h2>
      ...
      <section className="mt-10">
        <h2 className="text-sm font-medium text-zinc-700 dark:text-zinc-300">Webhook Stripe</h2>
        <p className="mt-1 text-xs text-zinc-500">
        ...
        <div className="mt-3 rounded-xl border border-zinc-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/60 p-6 shadow-sm hover:shadow-md dark:shadow-xl dark:shadow-black/20 dark:backdrop-blur-sm">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100">URL Endpoint</p>
          </div>
          <div className="mt-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {WEBHOOK_EVENTS.map((eventName) => (
              <Badge key={eventName} variant="outline" className="h-auto border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-950/60 px-2 py-1 font-mono text-[11px] text-zinc-600 dark:text-zinc-400">
                {eventName}
              </Badge>
            ))}
          </div>
      ...
      <section className="mt-10">
        <h2 className="text-sm font-medium text-zinc-700 dark:text-zinc-300">Chiavi API</h2>
        <p className="mt-1 text-xs text-zinc-500">
      ...
      <section className="mt-10">
        <h2 className="text-sm font-medium text-zinc-700 dark:text-zinc-300">Piano &amp; Fatturazione</h2>
        <p className="mt-1 text-xs text-zinc-500">
        ...
        <div className="mt-5 grid grid-cols-1 items-stretch gap-5 sm:grid-cols-3">
          {PLANS.map((plan) => (
            <div
              key={plan.id}
              className={cn(
                "flex h-full flex-col rounded-xl border border-zinc-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/60 p-6 shadow-sm hover:shadow-md dark:shadow-xl dark:shadow-black/20 dark:backdrop-blur-sm",
            ...
            >
              ...
              <div className="mt-3 flex items-baseline gap-1">
                <span className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">{plan.price}</span>
