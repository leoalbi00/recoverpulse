  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10 sm:py-12">
      ...
      <section className="mt-10">
        <h2 className="text-sm font-medium text-slate-700">Webhook Stripe</h2>
        <p className="mt-1 text-xs text-slate-500">
        ...
        <div className="mt-3 rounded-xl border border-slate-200/60 bg-white p-6 shadow-sm hover:shadow-md">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm font-medium text-slate-900">URL Endpoint</p>
          </div>
          <div className="mt-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {WEBHOOK_EVENTS.map((eventName) => (
              <Badge
                key={eventName}
                variant="outline"
                className="h-auto border-slate-200/60 bg-slate-100 px-2 py-1 font-mono text-[11px] text-slate-500"
              >
                {eventName}
              </Badge>
            ))}
      ...
      <section className="mt-10">
        <h2 className="text-sm font-medium text-slate-700">Chiavi API</h2>
        <p className="mt-1 text-xs text-slate-500">
