...
// OmniRev è in Beta Gratuita Pubblica: il checkout per l'abbonamento
...
export async function POST() {
  return NextResponse.json(
    {
      error:
        "OmniRev è attualmente in Beta Gratuita: il checkout è temporaneamente disabilitato. Usa la piattaforma al 100% senza costi di abbonamento.",
    },
    { status: 403 }
  );
}
